...
const Footer = () => {
  return (
    <footer className="mx-auto max-w-3xl px-3 sm:px-6 md:max-w-5xl pt-8 sm:pt-10 pb-10 sm:pb-12">
      <hr className="w-full h-px mx-auto mb-6 sm:mb-8 bg-neutral-200 dark:bg-stone-800 border-0" />
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-5 sm:gap-6 text-center md:text-left">
        <div>
          ...
          <div className="flex items-center justify-center md:justify-start gap-1.5 text-xs text-neutral-500 dark:text-neutral-400 mt-1">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3.5 sm:gap-6">
          ...
          <div className="text-[11px] sm:text-xs text-neutral-400 dark:text-neutral-500">
